...
| **iderēbagon**(?)| reembolsar? (V-?)                       | **iderēptot** (?)   | (forma flexionada de *iderēbagon*?)             |
...
| **qīng** (?)     | quando, enquanto (Conj Subord Temp?)    | **qrinuntys** (?)   | (palavra hipotética)                            |
...
| **Velaryon**     | (Nome de Família)                       | **velmar** (?)      | irmão? (N-L?/Sg)                                |
